      ...
      <div style={{
        ...
        <div>
          ...
          <h2 style={{
            ...
            Votre espace de formation <br />
            <span style={{ color: C.orange }}>Kubernetes</span>
          </h2>
          <p style={{
            fontSize: '13px', color: '#888', lineHeight: 1.7,
            margin: 0, fontFamily: FONT,
          }}>
            Pratiquez dans des environnements isolés et sécurisés,
            conçus pour les équipes Orange.
          </p>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          {[
            'Environnements Docker isolés',
            'Suivi de progression en temps réel',
            'Labs Kubernetes certifiants',
          ].map(txt => (
